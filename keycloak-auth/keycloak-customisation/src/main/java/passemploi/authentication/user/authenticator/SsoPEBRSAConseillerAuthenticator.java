...
public class SsoPEBRSAConseillerAuthenticator implements Authenticator {
  protected static final Logger logger = Logger.getLogger(SsoPEBRSAConseillerAuthenticator.class);
  private final UserRepository userRepository;
  private final PoleEmploiRepository poleEmploiRepository;
  private final String socialProvider;

  public SsoPEBRSAConseillerAuthenticator(String provider) {
